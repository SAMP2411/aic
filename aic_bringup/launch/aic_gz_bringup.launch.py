...
def launch_setup(context, *args, **kwargs):
    ...
    delay_fts_broadcaster_after_joint_state = RegisterEventHandler(
        event_handler=OnProcessExit(
            target_action=joint_state_broadcaster_spawner,
            on_exit=[fts_broadcaster_spawner],
        )
    )

    delay_initial_controller_after_fts = RegisterEventHandler(
        event_handler=OnProcessExit(
    ...
    nodes_to_start = [
        ...
        delay_fts_broadcaster_after_joint_state,
        delay_initial_controller_after_fts,
